...
// Lightbox dell'opera: usa la modale base (Modal) per portal/overlay/focus-trap/
// Esc/animazioni. Aggiunge ciò che è suo — layout a due colonne (opera + dettagli),
// frecce prev/next, contatore, descrizione, striscia paginata, vista a schermo intero.
              ...
              {hasDescription && (
                <div className="artwork-desc flex-column gap-10px">
                  {/* toggle: su desktop è solo un titolo (icona nascosta, sempre
                      aperta via CSS); su mobile funge da accordion animato */}
                  <button
                    type="button"
